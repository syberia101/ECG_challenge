...
def parse_entity(dblp_path, save_path, conf_name, type_name, features=None, save_to_csv=False, include_key=False):
...
def parse_proceedings(dblp_path, save_path, conf_name, save_to_csv=False, include_key=False ):
    type_name = ["inproceedings", "proceedings"]
    features = ['title', 'author', 'year', 'pages', 'booktitle','pages','venue','ee','doi','key']
    info = parse_entity(dblp_path, save_path, conf_name, type_name, features, save_to_csv=save_to_csv, include_key=include_key)
...
def main():
    ...
    try:
        ...
        exit()
    parse_proceedings(dblp_path, save_path, conf_name, save_to_csv=False)
